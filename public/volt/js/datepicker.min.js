var Datepicker = function () {
    ...
    const C = new WeakMap, {addEventListener: O, removeEventListener: E} = EventTarget.prototype;
            ...
            if (this.picker.setViewSwitchLabel(e), this.picker.setPrevBtnDisabled(this.first <= this.minDate), this.picker.setNextBtnDisabled(this.last >= this.maxDate), this.calendarWeeks) {
                ...
                Array.from(this.calendarWeeks.weeks.children).forEach((t, i) => {
                    t.textContent = function (e) {
                        const t = m(e, 4, 1), i = m(new Date(t).setMonth(0, 4), 4, 1);
    ...
    class Q extends z {
        ...
        init(e, t = !0) {
            t && (this.grid = this.element, this.element.classList.add("months", "datepicker-grid"), this.grid.appendChild(A(r("span", 12, {"data-month": e => e})))), super.init(e)
        }
        ...
        render() {
            ...
            const e = this.selected[this.year] || [], t = this.year < this.minYear || this.year > this.maxYear,
                i = this.year === this.minYear, s = this.year === this.maxYear, a = G(this.range, this.year);
        ...
        refresh() {
            const e = this.selected[this.year] || [], [t, i] = G(this.range, this.year) || [];
            this.grid.querySelectorAll(".range, .range-start, .range-end, .selected, .focused").forEach(e => {
                e.classList.remove("range", "range-start", "range-end", "selected", "focused")
    ...
    class Z extends z {
        ...
        updateFocus() {
            const e = new Date(this.picker.viewDate), t = g(e, this.navStep), i = t + 9 * this.step;
    ...
    class ce {
        constructor(e) {
            ...
            const t = J.replace(/%buttonClass%/g, e.config.buttonClass),
                i = this.element = A(t).firstChild, [s, a, n] = i.firstChild.children,
            ...
            i.classList.add(`datepicker-${p}`), ne(this, e.config), this.viewDate = re(e), F(e, [[i, "click", function (e) {
