...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateButtonText() {
        ...
        icon.innerHTML = isDarkMode
            ...
            : '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16"><path d="M6 0a7 7 0 0 0 0 14a7.002 7.002 0 0 1 6.938-6.019a.5.5 0 0 0 .5-.5A7 7 0 0 0 6 0z"/></svg>';
