    ...
    <div class="row mb-5">
        <div class="d-flex best">
            ...
            <div class="col-md-2 p-2 mx-3 card card-body position-relative">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" stroke="black" class="bi bi-suit-heart-fill position-absolute top-0 end-0 m-2 heart-icon redirect-to-login heart-icon-grow" viewBox="0 0 16 16">
