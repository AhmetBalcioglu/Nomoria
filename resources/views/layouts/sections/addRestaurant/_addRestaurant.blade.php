        ...
        <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-select custom-select" id="category" name="category" required>
                        ...
                        <option value="Mediterranean">Akdeniz Restoranları</option>
                        <option value="Asian">Asya Restoranları</option>
                        <option value="Barbecue">Barbekü Restoranları</option>
                        <option value="Chinese">Çin Restoranları</option>
                        <option value="Seafood">Deniz Ürünleri Restoranları</option>
                        <option value="French">Fransız Restoranları</option>
                        <option value="Indian">Hint Restoranları</option>
                        <option value="Italian">İtalyan Restoranları</option>
                        <option value="Mexican">Meksika Restoranları</option>
                        <option value="Turkish">Türk Restoranları</option>
                        <option value="Vegetarian">Vejetaryen/Vegan Restoranları</option>
                        <option value="Japanese">Japon Restoranları</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" id="add-detail">+ Detay Ekle</button>
                </div>
            </div>
